    ...
    <View style={{backgroundColor: 'white', height: '100%'}}>
      <View style={{marginLeft: '10%', marginRight: '10%', marginTop: '10%'}}>
        <View style={{flexDirection: 'row'}}>
          <Text style={{color: '#084887', fontSize: 40, fontWeight: 'bold'}}>
            Bonjour
          </Text>
        ...
        <View
          ...
          <Image
            ...
            style={{height: 135, width: 135, borderRadius: 75}}></Image>
        </View>
        ...
        <TouchableOpacity onPress={() => setUser({...user, isLogged: true})}>
